        ...
        <div class="login-screen">
            ...
            <form action="/login" method="POST">
                ...
                <div class="form-group">
                    <input type="email" name="email" class="form-control shadow p-3 mb-2 bg-white rounded-lg"
                        id="email" aria-describedby="emailHelp" placeholder="Email Address"
                        value="{{ Session::get('email') }}" required>
                </div>
                <div class="form-group">
                    <input type="password" name="password" class="form-control shadow p-3 mb-2 bg-white rounded"
